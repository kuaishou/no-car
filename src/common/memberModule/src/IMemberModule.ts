...
interface IMemberModule {
     ...
     * */ 
    accessRecordWeiXin(data: {productName: string, productId?: string, salesCode?: string, comeFrom?: string, issueChannel?: string} ): any
}
